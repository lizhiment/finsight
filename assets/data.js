...
const COMPANIES = {
  ...
  '601728': {
    code: '601728', name: '中国电信', short: '电信', exchange: '上交所',
    industry: '通信运营', regDate: '2021-08-20',
    reports: ['2025年报', '2024年报', '2024三季报'],
    desc: '国内领先的通信运营商，主营移动通信、固网及天翼云等综合信息服务。',
  },
};
...
const FINANCIALS = {
  ...
  '601728': {
    company: '中国电信', code: '601728', report: '2025年年度报告', reportDate: '2026-03-24',
    period: '2025-12-31', currency: '人民币元',
    income: {
      '营业收入': 529400000000, '营业成本': 421000000000, '营业利润': 51400000000,
      '利润总额': 51500000000, '净利润': 42500000000, '归母净利润': 39200000000,
      '扣非净利润': 37200000000, '基本每股收益': 0.42,
    },
    balance: {
      '总资产': 900000000000, '总负债': 470000000000, '股东权益合计': 430000000000,
      '归母净资产': 350000000000, '流动资产': 210000000000, '流动负债': 330000000000,
      '货币资金': 62000000000, '应收账款': 42000000000, '存货': 28000000000,
    },
    cashflow: {
      '经营活动现金流净额': 168000000000, '投资活动现金流净额': -95000000000,
      '筹资活动现金流净额': -52000000000, '现金及等价物净增加额': 21000000000,
    },
    ratios: {
      '毛利率': 30.4, '净利率': 8.0, 'ROE': 10.2, 'ROA': 4.7,
      '资产负债率': 52.2, '流动比率': 0.64, '经营现金流/净利润': 3.95,
      '市盈率': 18.6, '市净率': 1.9, '每股收益': 0.42,
    },
    segments: [
      { name: '移动通信服务', revenue: 210000000, ratio: 39.7 },
      { name: '固网及智慧家庭', revenue: 125000000, ratio: 23.6 },
      { name: '产业数字化', revenue: 194000000, ratio: 36.7 },
    ],
    years: {
      '2023': { '营业收入': 513600000000, '净利润': 30400000000 },
      '2024': { '营业收入': 550900000000, '净利润': 33000000000 },
      '2025': { '营业收入': 529400000000, '净利润': 42500000000 },
    },
  },
};
